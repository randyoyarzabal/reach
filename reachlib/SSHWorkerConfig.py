...
# String defaults
STRING_DEFAULTS = (CIPHER_KEY_FILE, LOGS_DIRECTORY, INVENTORY_FILE, IP_OR_HOST_COLUMN, HOST_DISPLAY_FORMAT, SSH_USER_NAME,
...
config[INVENTORY_FILE] = defaults[INVENTORY_FILE]
